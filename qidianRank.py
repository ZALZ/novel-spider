...
def main():
    url = 'https://www.qidian.com/rank/yuepiao?style=1&month={}&chn=-1&year={}'
    monthdict = {1:"01",2:"02",3:"03",4:"04",5:"05",6:"06",7:"07",8:"08",9:"09",10:"10",11:"11",12:"12",}
    file = open("qidianRank.csv","w+")
    file.write("name,type,value,date\n")
    for year in range(2005,2019):
        for month in range(1,13):
            if year == 2005 and month == 1:
                continue
            if year == 2018 and month > 7:
                break
            print(year,"-",month)
            get_html(url.format(monthdict[month],year),file,str(year)+"-"+str(month))
            #time.sleep(1)
